...
- [x] **Command menu** — classic JRPG box (Attack / Glyphs / Defend / Item): arrows navigate, **Enter or Space** confirms/descends, **Esc** backs out, with cursor memory · `tests/menu.test.ts`
